function [SavePhaseDiffB4NoiseD,SavePhaseDiffAfterNoiseD,SaveAvgSNRD,SavePhaseNoiseD]=CalculateAndSavePhaseNoise_SNR_Variance_for_All_D(pdLongTraceAllFiltered,FinalMaskEarthQuake,PeakSNR2D,delp,nNoiseStdTimes,nFinalFilter,n,nInitVol,nAlineGap,...
    bFinalMasking,SNRMask_Comb_AlineGap_delp,bSNRMask)
